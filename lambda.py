...
WEBHOOK_URL = os.environ.get('WEBHOOK_URL')  # Public URL for webhook (e.g., https://your-domain.com/webhook)
...
def main() -> None:
    ...
    def set_webhook():
        success = application.bot.set_webhook(url=f"{WEBHOOK_URL}/webhook")
        if success:
